...
[ViewComponent]
public class HeaderLanguageV2ViewComponent : ViewComponent
{
    private readonly IMemoryCache _cache;
    private readonly IStoreContentApi _content;
    private readonly IStoreAuthService _auth;

    public HeaderLanguageV2ViewComponent(IMemoryCache cache, IStoreContentApi content, IStoreAuthService auth)
    {
        _cache = cache;
        _content = content;
        _auth = auth;
